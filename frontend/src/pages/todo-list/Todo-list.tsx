...
export default function TodoList() {
  ...
  const [currentSection, setCurrentSection] = useState(
    CurrentSectionService().getSection()
  );
  const [tasksOverview, setTaskOverview] = useState(
    TaskService().returnTasksList("all")?.length
      ? `У вас всего ${TaskService().returnTasksList()?.length} задач`
      : "Список задач пуст"
  );
        ...
        >
          <div className="task__sections">
            <button
              ...
              style={{
                fontWeight: active === "all" ? "600" : "",
                color: active === "all" ? "lightGrey" : "",
              }}
            ...
            <button
              style={{
                fontWeight: active === "done" ? "600" : "",
                color: active === "done" ? "lightGrey" : "",
              }}
              className="task__section-btn"
            ...
            <button
              style={{
                fontWeight: active === "undone" ? "600" : "",
                color: active === "undone" ? "lightGrey" : "",
              }}
              className="task__section-btn"
            ...
            <>
              <form>
                ...
                <input
                  ...
                  onKeyUp={(event) =>
                    taskDataPostHandleChange(event, "description")
                  }
                />
              </form>
            </>
